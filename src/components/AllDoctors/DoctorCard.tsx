...
const DoctorCard = ({ doctor }: DoctorCardProps) => {
  ...
  return (
    <article className="group flex h-full flex-col overflow-hidden rounded-3xl border border-[#F5CBCB] bg-white shadow-sm transition duration-300 hover:-translate-y-1 hover:shadow-xl dark:border-[#41354A] dark:bg-[#2A2233]">
      <div className="relative h-52 shrink-0 overflow-hidden bg-gradient-to-br from-[#FBEFEF] via-[#FFE2E2] to-[#C5B3D3]/55 dark:from-[#352B3D] dark:via-[#2A2233] dark:to-[#41354A]">
        {doctor.image ? (
          // eslint-disable-next-line @next/next/no-img-element
          <img
            src={doctor.image}
