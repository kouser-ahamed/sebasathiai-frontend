...
//   // Preserve the current page (path + any query string) so login can send the user back here.
//   const currentUrl = `${pathname}${
//     searchParams.toString() ? `?${searchParams.toString()}` : ""
//   }`;
//   const loginHref = `/auth/login?callbackUrl=${encodeURIComponent(currentUrl)}`;
