...
const AIHealthAssistant = () => {
  ...
  return (
    <main className="h-[calc(100dvh-4rem)] min-h-0 overflow-hidden bg-[#FFF9F9] py-3 dark:bg-[#211B27] sm:h-[calc(100dvh-4.5rem)] sm:py-4">
      <div className="mx-auto flex h-full min-h-0 w-full max-w-7xl flex-col gap-3 px-4 sm:gap-4 sm:px-6 lg:px-4">
        <header className="shrink-0 overflow-hidden rounded-3xl border border-[#F5CBCB] bg-white shadow-sm dark:border-[#41354A] dark:bg-[#2A2233]">
          <div className="p-4 sm:p-5">
            <div className="min-w-0">
              <div className="flex flex-wrap items-center gap-2">
